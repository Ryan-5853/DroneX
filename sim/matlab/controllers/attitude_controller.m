function [T, alpha, beta, state_out] = attitude_controller(q, omega, att_des, state, p)
%% attitude_controller - 姿态控制器，输出推力与云台角
% q: 当前姿态四元数
% omega: 机体系角速度 [rad/s]
